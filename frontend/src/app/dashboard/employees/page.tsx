...
export default function EmployeesPage() {
  ...
  if (isLoading)
    return <div className="text-blue-700">Loading employees...</div>;
      ...
      {!showFallback ? (
        ...
        <div>
          <p className="text-blue-700 mb-2">
            No employees found or data format issue.
          </p>
          <pre className="bg-blue-50 p-2 rounded text-xs text-blue-900 overflow-x-auto max-w-full">
